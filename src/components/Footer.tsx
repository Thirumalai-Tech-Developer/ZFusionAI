        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-6">
            <Link href="/">
              <a className="flex items-center space-x-2 font-bold text-xl text-white mb-4">
                <img src={name} alt="GT Tech Logo" className="h-8"/>
              </a>
            </Link>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="Careers" className="text-gray-400 hover:text-orange-500 transition-colors">Careers</a>
              </li>
              <li>
                <a href="AboutUS" className="text-gray-400 hover:text-orange-500 transition-colors">About Us</a>
              </li>
              <li>
                <a href="ContactUS" className="text-gray-400 hover:text-orange-500 transition-colors">Contact</a>
              </li>
            </ul>
          </div>
